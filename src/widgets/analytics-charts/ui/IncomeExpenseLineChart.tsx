...
export function IncomeExpenseLineChart() {
  ...
  return (
    <ChartCard title={t('analytics.incomeExpenseTitle')} description={t('analytics.last6MonthsDynamics')}>
      <LineChart data={data} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
        ...
        <Line type="monotone" dataKey="income" name={t('analytics.incomeSeriesName')} stroke="var(--success)" strokeWidth={2.5} dot={{ r: 3 }} activeDot={{ r: 5 }} />
        <Line type="monotone" dataKey="expense" name={t('analytics.expensesSeriesName')} stroke="var(--destructive)" strokeWidth={2.5} dot={{ r: 3 }} activeDot={{ r: 5 }} />
      </LineChart>
    </ChartCard>
  );
}
